    ...
    <main className="app-shell cozy-home">
      <header className="topbar">
        <div className="brand">
          ...
          <div><b>毛孩生活中心 <span style={{ fontSize: '10px', background: '#d98a6c', color: '#fff', padding: '1px 5px', borderRadius: '4px', marginLeft: '4px', verticalAlign: 'middle' }}>v1.0.1</span></b><small>安心陪伴每一天</small></div>
        </div>
